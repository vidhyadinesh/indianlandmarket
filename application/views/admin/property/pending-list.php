...
<script>
$(document).ready(function () {	//alert('sdfds');

	$('#sort_property').on('change', function() {
			 var sortField = this.value;
			 var perpage = $('#per_page').val();
			 getPendingPropertyList(sortField, perpage);		 
	...
	/*$('#search').on('keypress', function() {
			 ...
			 getPropertyList(sortField,perpage,phrase);		 
			 
	});*/
 
 getPendingPropertyList();	
 
});

function getPendingPropertyList(sortField,perpage){
	  var offset = '';
	  ...
	  /*if(phrase){
		...
		var url = SITE_URL+"admin/property/pendinglist/"+''+offset;
		$.ajax({
			type: "POST",
			//dataType: 'json',
			data: {
		...
		$( '#pendingprop_container' ).html(response);	
