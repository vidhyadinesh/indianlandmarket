            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <a href="<?php echo site_url()."admin/subcategory/add"?>" class="btn btn-success waves-effect m-r-20">Add subcategory</a>
...
function getSubcategoryList(sortField,perpage){
	  var offset = '';
	  ...
	  /*if(phrase){
	    ...
	    var SITE_URL = "<?php echo site_url();?>";
		var url = SITE_URL+"admin/subcategory/listing/"+''+offset;
		$.ajax({
			type: "POST",
			//dataType: 'json',
			data: {
		...
		success: function(response){
			...
			$( '#subcategory_container' ).html(response);	
