            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                       <!-- Large Size -->
                                   <form class="form-horizontal" id="add_subcategory" method="post" action="<?php echo site_url()."/subcategory/save"?>">
                                    <div>
                                      <div class="row">
                                      <div class="col-sm-4">
                                      <select id="category_id" name="category_id" class="form-control">
                                        ...
                                        <?php foreach($categories as $row):?>
                                            <option value="<?php echo $row->id ?>" <?php if(isset($subcategory_details['category_id'])&& $subcategory_details['category_id']== $row->id){ ?> selected= selected<?php }?>><?php echo $row->category?></option>                
                                        <?php endforeach;?>
                                        </select>
                                      </div>
      
                                            <div class="col-md-4"><p>Add subcategory</p>
                                              <div class="form-group">
                                                <div class="form-line">
                                                <input type="hidden" name="id" value="<?php echo isset($subcategory_details['id'])? $subcategory_details['id']:''?>" id="id">
                                                  <input type="text" class="form-control" placeholder="add subcategory" id="subcategory" name="subcategory" value="<?php echo isset($subcategory_details['sub_category'])? $subcategory_details['sub_category']:''?>">
                                                  </div>
                                               </div>
                                            </div>                              
                                      </div>
