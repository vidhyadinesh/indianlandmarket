            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <a href="<?php echo site_url()."/admin/feature/add"?>" class="btn btn-success waves-effect m-r-20">Add feature</a>
...
function getFeatureList(sortField,perpage){
	  var offset = '';
	  ...
	  /*if(phrase){
	    ...
	    var SITE_URL = "<?php echo site_url();?>";
		var url = SITE_URL+"/admin/feature/listing/"+''+offset;
		$.ajax({
			type: "POST",
			//dataType: 'json',
			data: {
		...
		success: function(response){
			...
			$( '#feature_container' ).html(response);	
