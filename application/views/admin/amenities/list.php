            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <a href="<?php echo site_url()."/admin/amenity/add"?>" class="btn btn-success waves-effect m-r-20">Add amenities</a>
...
function getAmenitiesList(sortField,perpage){
	  var offset = '';
	  ...
	  /*if(phrase){
	    ...
	    var SITE_URL = "<?php echo site_url();?>";
		var url = SITE_URL+"/admin/amenity/listing/"+''+offset;
		$.ajax({
			type: "POST",
			//dataType: 'json',
			data: {
		...
		success: function(response){
			...
			$( '#amenities_container' ).html(response);	
