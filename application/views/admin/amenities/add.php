                                   ...
                                   <form class="form-horizontal" id="add_amenity" method="post" action="<?php echo site_url()."/amenity/save"?>">
                                    <div>
                                      <div class="row">
                                            ...
                                            <div class="col-md-4"><p>Add Amenity</p>
                                              <div class="form-group">
                                                <div class="form-line">
                                                <input type="hidden" name="id" value="<?php echo isset($amenities_details['id'])? $amenities_details['id']:''?>" id="id">
                                                  <input type="text" class="form-control" placeholder="add amenity" id="amenity" name="amenity" value="<?php echo isset($amenities_details['amenities'])? $amenities_details['amenities']:''?>">
                                                  </div>
                                               </div>
                                            </div>                              
                                      </div>
