      ...
      <div class="row">
        <div class="col-md-9">
          <div class="aa-properties-content">
            ...
            <div class="aa-properties-content-body" id="my_properties_container">
 ...
 <script>
  ...
  function getMyPropertyList(sortField,perpage){
	  var offset = '';
	  ...
	  //var sortField = this.value;
			 //alert(sortField);
		var url = "property/mylist/"+''+offset;
		$.ajax({
			type: "POST",
			//dataType: 'json',
			data: {
		...
		success: function(response){
			...
			$( '#my_properties_container' ).html(response);	
