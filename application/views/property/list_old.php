            ...
            <div class="aa-properties-content-body">
              <ul class="aa-properties-nav">
               <?php foreach($properties as $prop):?>
                  ...
                  <article class="aa-properties-item">
                    ...
                    <div class="aa-properties-item-content">
                      ...
                      <div class="aa-properties-detial">
                        <span class="aa-price">
                          $<?php echo $prop['estimated_price']?>
                        </span>
                        
                        <a class="aa-secondary-btn" href="<?php echo site_url()."/property/view/".$prop['id']?>">View Details</a>
						<a class="aa-secondary-btn" style="margin-right:10px;padding-bottom:0;" href="#"><span class="glyphicon glyphicon-star"></span>Add to Short list</a>
                ...
                <img class="img-responsive center-block" src="img/Banner-Ad-Horizontal-Buying-a-Home.jpg" width="728" height="90" alt=""/>
                </div>
